...
# Input
gflags.DEFINE_integer('img_width', 32, 'Target Image Width')
gflags.DEFINE_integer('img_height', 32, 'Target Image Height')
...
gflags.DEFINE_string('train_dir', "C:\dataset\Dronet\\training", 'Folder containing'
                     ' training experiments')
gflags.DEFINE_string('val_dir', "C:\dataset\Dronet\\validation", 'Folder containing'
